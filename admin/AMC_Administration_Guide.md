...
4) `Page Inspector:` This step allows you to create a step for scanning a custom document and extracting data from custom fields, as well as, setting custom zones for signature placement. To do so, do the following steps:
